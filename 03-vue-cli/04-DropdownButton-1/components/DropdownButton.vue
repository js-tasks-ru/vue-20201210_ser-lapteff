<!--
Кнопке можно добавить неактивное состояние.
Варианту из списка можно добавить тоже неактивное состояние, также выделить уже выбранныей вариант.
Думаю сам выпадающий список можно вынести в отдельный компонет.
-->
  ...
  <div class="dropdown" :class="{ show: isShow }">
    ...
    <div class="dropdown__menu" :class="{ show: isShow }">
      <button
        ...
        :class="{ dropdown__item_icon: hasWithIcon }"
        type="button"
      >
